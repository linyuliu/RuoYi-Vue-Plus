package ${projectMetadata.groupId}.common.social.utils;
...
import ${projectMetadata.groupId}.common.social.gitea.AuthGiteaRequest;
import ${projectMetadata.groupId}.common.social.maxkey.AuthMaxKeyRequest;
import ${projectMetadata.groupId}.common.social.topiam.AuthTopIamRequest;
