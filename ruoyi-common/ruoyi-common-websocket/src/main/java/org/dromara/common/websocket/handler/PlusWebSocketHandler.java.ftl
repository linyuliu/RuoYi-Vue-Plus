package ${projectMetadata.groupId}.common.websocket.handler;

import cn.hutool.core.util.ObjectUtil;
import lombok.extern.slf4j.Slf4j;
import ${projectMetadata.groupId}.common.core.domain.model.LoginUser;
import ${projectMetadata.groupId}.common.websocket.dto.WebSocketMessageDto;
import ${projectMetadata.groupId}.common.websocket.holder.WebSocketSessionHolder;
import ${projectMetadata.groupId}.common.websocket.utils.WebSocketUtils;
