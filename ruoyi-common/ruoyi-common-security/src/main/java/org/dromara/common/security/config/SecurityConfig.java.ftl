package ${projectMetadata.groupId}.common.security.config;
...
import ${projectMetadata.groupId}.common.core.constant.HttpStatus;
...
import ${projectMetadata.groupId}.common.security.config.properties.SecurityProperties;
import ${projectMetadata.groupId}.common.security.handler.AllUrlHandler;
