package ${projectMetadata.groupId}.common.web.handler;
...
import ${projectMetadata.groupId}.common.core.exception.SseException;
import ${projectMetadata.groupId}.common.core.exception.base.BaseException;
