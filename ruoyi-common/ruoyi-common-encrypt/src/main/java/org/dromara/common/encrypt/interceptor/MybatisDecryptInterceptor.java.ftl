package ${projectMetadata.groupId}.common.encrypt.interceptor;
...
import ${projectMetadata.groupId}.common.encrypt.annotation.EncryptField;
import ${projectMetadata.groupId}.common.encrypt.core.EncryptContext;
