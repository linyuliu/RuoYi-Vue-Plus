<#if featureFlags.redis.enabled!true>
package ${projectMetadata.groupId}.common.redis.config;
...
import ${projectMetadata.groupId}.common.redis.handler.KeyPrefixHandler;
import ${projectMetadata.groupId}.common.redis.handler.RedisExceptionHandler;
