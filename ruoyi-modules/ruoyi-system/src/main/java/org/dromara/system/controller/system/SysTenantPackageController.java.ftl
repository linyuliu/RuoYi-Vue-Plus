package ${projectMetadata.groupId}.system.controller.system;
...
import ${projectMetadata.groupId}.system.domain.bo.SysTenantPackageBo;
import ${projectMetadata.groupId}.system.domain.vo.SysTenantPackageVo;
import ${projectMetadata.groupId}.system.service.ISysTenantPackageService;
