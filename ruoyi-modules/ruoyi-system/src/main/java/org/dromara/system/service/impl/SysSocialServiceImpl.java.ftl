...
import ${projectMetadata.groupId}.system.domain.SysSocial;
import ${projectMetadata.groupId}.system.domain.bo.SysSocialBo;
import ${projectMetadata.groupId}.system.domain.vo.SysSocialVo;
import ${projectMetadata.groupId}.system.mapper.SysSocialMapper;
