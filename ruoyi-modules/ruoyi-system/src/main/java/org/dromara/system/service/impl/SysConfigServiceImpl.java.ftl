...
import ${projectMetadata.groupId}.common.core.service.ConfigService;
...
import ${projectMetadata.groupId}.system.domain.SysConfig;
import ${projectMetadata.groupId}.system.domain.bo.SysConfigBo;
import ${projectMetadata.groupId}.system.domain.vo.SysConfigVo;
import ${projectMetadata.groupId}.system.mapper.SysConfigMapper;
