package ${projectMetadata.groupId}.demo.domain.vo;
...
import ${projectMetadata.groupId}.common.core.enums.UserStatus;
...
import ${projectMetadata.groupId}.common.excel.annotation.ExcelDictFormat;
import ${projectMetadata.groupId}.common.excel.annotation.ExcelEnumFormat;
import ${projectMetadata.groupId}.common.excel.convert.ExcelDictConvert;
import ${projectMetadata.groupId}.common.excel.convert.ExcelEnumConvert;
