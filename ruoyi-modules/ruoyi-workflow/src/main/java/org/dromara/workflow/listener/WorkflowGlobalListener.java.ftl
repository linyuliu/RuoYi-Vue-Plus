package ${projectMetadata.groupId}.workflow.listener;
...
import ${projectMetadata.groupId}.warm.flow.core.listener.GlobalListener;
import ${projectMetadata.groupId}.warm.flow.core.listener.ListenerVariable;
...
import ${projectMetadata.groupId}.workflow.domain.bo.FlowCopyBo;
