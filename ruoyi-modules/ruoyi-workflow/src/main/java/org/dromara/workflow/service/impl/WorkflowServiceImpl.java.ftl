...
import ${projectMetadata.groupId}.common.core.domain.dto.CompleteTaskDTO;
import ${projectMetadata.groupId}.common.core.domain.dto.StartProcessDTO;
...
import ${projectMetadata.groupId}.workflow.domain.bo.CompleteTaskBo;
import ${projectMetadata.groupId}.workflow.domain.bo.StartProcessBo;
