...
import ${projectMetadata.groupId}.workflow.domain.bo.FlowCategoryBo;
import ${projectMetadata.groupId}.workflow.domain.vo.FlowCategoryVo;
import ${projectMetadata.groupId}.workflow.mapper.FlwCategoryMapper;
import ${projectMetadata.groupId}.workflow.service.IFlwCategoryService;
